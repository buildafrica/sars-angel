...
/* Producer function returns an object of intended recipients for a channel type */
exports.emailProducer = function () { return __awaiter(void 0, void 0, void 0, function () {
    var recipients, result, recordCreatedOption;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                logger_1.default.info('email.producer started');
                return [4 /*yield*/, statemen_entities_1.getStatemen()];
            case 1:
                recipients = _a.sent();
                result = recipients
                    .filter(function (record) { return record.email !== undefined; })
                    .map(function (val, _index) {
                    return { email: val.email, name: val.name };
                });
                recordCreatedOption = {
                    recipients: result.length + " Recipients",
                    channel: interface_1.CHANNEL.EMAIL,
                    message: "A " + interface_1.CHANNEL.EMAIL + " worker has been initiated on " + new Date().toUTCString() + " with " + result.length + " Recipients",
                    time: new Date().toString()
                };
                return [4 /*yield*/, airtable.createOneRecord('Scheduled_Messages', recordCreatedOption)];
            case 2:
                _a.sent();
                logger_1.default.info("email.producer payload generated");
