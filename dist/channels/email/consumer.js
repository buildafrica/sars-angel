        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, messages_entities_1.getEmailPayload()];
                case 1:
                    message = _a.apply(void 0, [_b.sent()]) || '';
                    postmark_provider_1.default(email, name, message);
                    return [2 /*return*/];
            }
        });
    }); });
